...
CREATE PROCEDURE SafeDropAndCreateIndexSharedWorkstations(
...
-- 2. Execute the procedure for the SharedWorkstations index
CALL SafeDropAndCreateIndexSharedWorkstations('SharedWorkstations', 'idx_SharedWorkstations_IsActive', 'IsActive');

-- 3. Clean up the procedure from the database
DROP PROCEDURE IF EXISTS SafeDropAndCreateIndexSharedWorkstations;
