...
CREATE PROCEDURE SafeDropAndCreateSubordinateIndex(
...
-- 2. Execute the procedure for the WorkOrderSubordinateParts index
CALL SafeDropAndCreateSubordinateIndex('WorkOrderSubordinateParts', 'idx_WorkOrderSubordinateParts_CachedAt', 'CachedAt');

-- 3. Clean up the procedure from the database
DROP PROCEDURE IF EXISTS SafeDropAndCreateSubordinateIndex;
